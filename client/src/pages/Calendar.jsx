...
import {
  ...
  SaveOutlined, TeamOutlined, CameraOutlined
...
const Calendar = () => {
  ...
  const handleExportPNG = async () => {
    ...
    message.loading({ content: 'Generating PNG...', key: 'png' });
    ...
    try {
      ...
      message.success({ content: 'Timetable exported as PNG!', key: 'png' });
    } catch (error) {
      console.error('PNG export error:', error);
      message.error({ content: 'Failed to generate PNG', key: 'png' });
    }
  };
